    ...
    int main(){
        ...
        do{
            ...
            cout << "[4] ESCREVER UMA MENSAGEM" << endl;
            cout << "[5] VER MENSAGENS DE UM CONTATO" << endl;
            cout << "[6] SAIR" << endl;
            cin >> op;
            cin.ignore();
            ...
            for(int i = 0; i<contatos.size(); i++){
                ...
                vector<int> amigosDoContato = contatos[i].retornaAmigos(contatos[i].getAmigos()); //Retorno os amigos
                for(int j = 0; j<amigosDoContato.size(); j++){ // Busca pelos amigos na lista de contatos
                        for(int m = 0; m<contatos.size(); m++){
                            if(amigosDoContato[j] == contatos[m].getId()){ //Achei um amigo
                                cout << "Nome : " <<contatos[m].getNome() << endl;
                            }
                        }
                }
                // break; pode ser necessário o uso do break aqui
                }
            }
